"""
download_fed_rates_data.py
====================================
Download orderbook data for Fed interest rate market

This script downloads orderbook snapshots for Oct 15-31, 2025 and saves:
...
Date Range: October 15-31, 2025 (17 days)

Usage:
    python download_fed_rates_data.py

Output:
    data/orderbook_fed_oct15_31_raw.json - Full snapshots with all levels
    data/orderbook_fed_oct15_31_processed.csv - Processed metrics
"""
...
# Load market info
with open('data/fed_rates_market.json', 'r') as f:
    market_info = json.load(f)

# Extract Yes token ID (for "Yes, 25bps decrease" outcome)
...
def main():
    print("\n")
    print("╔" + "═" * 78 + "╗")
    print("║" + " " * 10 + "FED INTEREST RATE MARKET - ORDERBOOK DOWNLOAD" + " " * 22 + "║")
    print("║" + " " * 10 + "October 15-31, 2025" + " " * 48 + "║")
    print("╚" + "═" * 78 + "╝")
    ...
    print(f"💵 Volume: ${market_info['volumeNum']:,.2f}")
    print(f"💧 Liquidity: ${market_info['liquidityNum']:,.2f}")
    ...
    raw_file = 'data/orderbook_fed_oct15_31_raw.json'
    print(f"\n💾 Saving to: {raw_file}")
    ...
    # Save processed data
    processed_file = 'data/orderbook_fed_oct15_31_processed.csv'
    ...
    print("=" * 80)
    print("\n📋 NEXT STEPS:")
    print("   1. Run: python calculate_ofi_fed.py")
    print("   2. Run: python regression_analysis_fed.py")
    print("   3. Run: python visualize_fed_orderbook.py")
    print("\n")
